...
Color4B Block::getBkColorByValue(int value)
{
	static std::map<int, Color4B> bkColorMap = {
		{ -1, Color4B(0xee, 0xe4, 0xda, 100) },
		{ 0, Color4B(0xee, 0xe4, 0xda, 0xFF) },
		...
		{ 4096, Color4B(0x3c, 0x3a, 0x32, 0xFF) }
	};
